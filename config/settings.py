...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        # Quitamos SessionAuthentication para evitar el bloqueo estricto de cookies/CSRF
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'tickets@seech.gob.mx')
