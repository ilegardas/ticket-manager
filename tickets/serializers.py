...
class TicketSerializer(serializers.ModelSerializer):
    ...
    def get_fecha_asignacion(self, obj): return obj.fecha_asignacion.isoformat() if obj.fecha_asignacion else obj.fecha_creacion.isoformat() if obj.fecha_creacion else "2026-06-24T00:00:00Z"
    def get_fecha_primera_respuesta(self, obj): return obj.fecha_primera_respuesta.isoformat() if obj.fecha_primera_respuesta else obj.fecha_creacion.isoformat() if obj.fecha_creacion else "2026-06-24T00:00:00Z"
    def get_fecha_resolucion(self, obj): return obj.fecha_resolucion.isoformat() if obj.fecha_resolucion else obj.fecha_creacion.isoformat() if obj.fecha_creacion else "2026-06-24T00:00:00Z"
    def get_fecha_cierre(self, obj): return obj.fecha_cierre.isoformat() if obj.fecha_cierre else obj.fecha_creacion.isoformat() if obj.fecha_creacion else "2026-06-24T00:00:00Z"
